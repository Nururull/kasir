                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-8 text-end">
                        <ul class="nav nav-pills d-inline-flex text-center mb-5">
                            <li class="nav-item">
                                <a class="d-flex m-2 py-2 bg-light rounded-pill {{ $selectedCategoryId == 'all' ? 'active' : '' }}"
                            ...
                            @foreach ($category as $item)
                                <li class="nav-item">
                                    <a class="d-flex m-2 py-2 bg-light rounded-pill {{ $selectedCategoryId == $item->id ? 'active' : '' }}"
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative fruite-item">
                                                <div class="fruite-img">
                                                    <img width="150px" src="{{ asset('images/' . $item->image_path) }}"
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    ...
                                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                                        <p class="text-dark fs-5 fw-bold mb-0">Rp.
                                                            {{ number_format($item->selling_price, 2) }}/ kg</p>
                                                        @if (Auth::check())
                                                            @if ($item->quantity > 0)
                                                            ...
                                                            @else
                                                                <span
                                                                    ...
                                                                    <i class="fa fa-times-circle me-2 text-danger"></i> Sold
                                                                    Out
                                                                </span>
                                                            @endif
                                                        @else
